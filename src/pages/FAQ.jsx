            ...
            <Container>
                ...
                <Accordion>
                    <Accordion.Toggle as={Button} variant="link" eventKey="0">
                        Why should I use Nordico?
                </Accordion.Toggle>
                    <Accordion.Collapse eventKey="0">
                        <div>
                        Nordico’s engine accesses thousands of flights and hotels in real time, comparing prices, locations, and schedules to build the best possible trip for you.
                ...
                <Accordion.Toggle as={Button} variant="link" eventKey="1">
                        What is the cost for using Nordico?
                </Accordion.Toggle>
                    <Accordion.Collapse eventKey="1">
                        <div>
                        Nordico does not charge you any fee. Our service is provided free of charge and to no extra cost to the user.
